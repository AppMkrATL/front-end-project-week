## created new branch "backend_project_week"  changing the frontend to connect to a database
...
## Trello Set Up:  https://trello.com/b/6xynL163/lambda-notes-sam-khaled 
